...
public class TemplateView extends FrameLayout {
	...
	public String getTemplateTypeName() {
		if (templateType == R.layout.gt_custom_medium_template_view) {
			return MEDIUM_TEMPLATE;
		} else if (templateType == R.layout.gt_small_template_view) {
		...
		try {
			templateType =
					attributes.getResourceId(
							R.styleable.TemplateView_gt_template_type, R.layout.gt_custom_medium_template_view);
		} finally {
			attributes.recycle();
		}
	...
	public void onFinishInflate() {
		...
		nativeAdView = findViewById(R.id.native_ads_view);
		primaryView = findViewById(R.id.primarys);
		secondaryView = findViewById(R.id.secondarys);
		tertiaryView = findViewById(R.id.bodys);

		ratingBar = findViewById(R.id.rating_bars);
		ratingBar.setEnabled(false);

		callToActionView = findViewById(R.id.ctas);
		iconView = findViewById(R.id.icons);
		mediaView = findViewById(R.id.media_views);
