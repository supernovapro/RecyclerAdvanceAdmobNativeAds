package com.supernova.new_recyclerview_native_ads.admob_advanced_native_recyvlerview;
...
import com.supernova.new_recyclerview_native_ads.R;
import com.supernova.new_recyclerview_native_ads.nativetemplates.NativeTemplateStyle;
import com.supernova.new_recyclerview_native_ads.nativetemplates.TemplateView;
import com.supernova.new_recyclerview_native_ads.rvadapter.RecyclerViewAdapterWrapper;
...
public class AdmobNativeAdAdapter extends RecyclerViewAdapterWrapper {
	...
	private RecyclerView.ViewHolder onCreateAdViewHolder(ViewGroup parent) {
		...
		LinearLayout adLayoutContent = (LinearLayout) inflater
				.inflate(R.layout.m_item_admob_native_ad, parent, false);
	...
	public static class Builder {
		...
		public static Builder with(String placementId, RecyclerView.Adapter wrapped, String layout) {
			...
			param.itemContainerLayoutRes = R.layout.m_item_admob_native_ad_outline;
			param.itemContainerId = R.id.ads_container;
	...
	private static class AdViewHolder extends RecyclerView.ViewHolder {
		...
		AdViewHolder(View view) {
			super(view);
			templatesmall = view.findViewById(R.id.m_templatesmall);
			templatecustom = view.findViewById(R.id.m_templatecustom);
			templatemedium = view.findViewById(R.id.m_templatemedium);
			loaded = false;
			adContainer = view.findViewById(R.id.native_ads_container);
		}
